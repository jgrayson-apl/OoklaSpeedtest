...
| **ooklaUrl**  | This is the custom Ookla test url you've configured at https://account.speedtestcustom.com/login <ul>REQUIRED<li>Speedtest Custom *Premium*.</li><li>Must be https enabled.</li></ul>|
